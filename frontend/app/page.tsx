...
export default function Home() {
  ...
  return (
    <>
      <main className="min-h-screen pt-16 bg-gradient-to-b from-background via-background/80 to-accent/20 overflow-hidden">
        {/* Hero Section */}
        <section id="hero-section" ref={scrollRef} className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          >
            <motion.div
              ...
              className="bg-primary/10 rounded-full p-4 w-24 h-24 flex items-center justify-center mx-auto mb-2"
            >
            ...
            <motion.p
              ...
              className="text-md md:text-lg text-muted-foreground max-w-2xl mx-auto"
            >
              Democratizing legal assistance through AI-powered solutions. 
              Equal access to justice is not just a promise—it's our mission.
            </motion.p>
            ...
            >
              <Button size="lg" className="bg-primary text-primary-foreground group shadow-lg shadow-primary/20" asChild>
              ...
              <Button size="lg" variant="outline" className="group" asChild>
                <Link href="/cases">
                  Explore Cases
                  <Database className="ml-2 h-4 w-4 group-hover:scale-110 transition-transform" />
                </Link>
              </Button>
          ...
          <motion.div
            ...
            className="absolute bottom-10 text-center w-full flex flex-col items-center"
          >
            <p className="text-lg italic text-muted-foreground px-4 mb-4">
              "In the court of technology, justice is served 24/7"
            </p>
            <motion.div
              animate={{ y: [0, 10, 0] }}
        ...
        <footer className="bg-background/90 border-t border-border/40 py-12 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-10 pt-6 border-t border-border/20 flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-muted-foreground">
                © 2023 LAW-DER. All rights reserved.
              </p>
